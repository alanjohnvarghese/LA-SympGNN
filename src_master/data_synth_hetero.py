#From: https://github.com/jeongwhanchoi/GREAD/
from deeprobust.graph.data import Dataset, Dpr2Pyg, Pyg2Dpr
import os.path as osp
import numpy as np
import torch

#adopted from https://github.com/GemsLab/H2GCN/tree/master/npz-datasets and data downloaded using the script in the repo
